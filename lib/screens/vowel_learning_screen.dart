...
import '../data/basic_vowels.dart';
import '../models/hangul_letter.dart';
import '../services/tts_service.dart';
import 'vowel_quiz_screen.dart';

class VowelLearningScreen extends StatefulWidget {
  const VowelLearningScreen({super.key, this.speechPlayer});
...
class _VowelLearningScreenState extends State<VowelLearningScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Nguyên âm cơ bản')),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 6),
            FilledButton.icon(
              key: const Key('start-vowel-quiz'),
              style: FilledButton.styleFrom(
                minimumSize: const Size.fromHeight(52),
              ),
              onPressed: () => Navigator.of(context).push<void>(
                MaterialPageRoute(builder: (_) => const VowelQuizScreen()),
              ),
...
class _VowelCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      key: ValueKey('vowel-${vowel.character}'),
      child: Padding(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      _AudioButton(
                        key: ValueKey(
                          'vowel-character-audio-${vowel.character}',
                        ),
                  ...
                  Row(
                    children: [
                      ...
                      _AudioButton(
                        key: ValueKey(
                          'vowel-examples-audio-${vowel.character}',
                        ),
